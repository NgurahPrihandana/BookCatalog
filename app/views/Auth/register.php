...
<div class="container d-flex flex-column justify-content-between" style="height: 100vh;">
    ...
    <div class="row justify-content-center align-items-center rounded bg-light" style="overflow: hidden;"> 
        ...
        <div class="col-lg-6 col-12 border p-4 text-white" style="background-color: #1E1E1E; border:none!important; min-width: 30rem">
            ...
            <p class="mt-0 pb-2 mb-4">Please fill the form below to create a new account</p>
            <div class="form-group p-1">
                ...
                <div class="form-group p-1">
                    ...
                    <input type="password" name="password" class="form-control rounded-3 border-success bg-transparent" style="border-width: 2px!important; background-color: #2b2b2a!important;" required>
                </div>
                <div class="form-group p-1">
                    <label for="conf-password">Confirm Password</label>
                    <input type="conf-password" name="conf-password" class="form-control rounded-3 border-success bg-transparent" style="border-width: 2px!important; background-color: #2b2b2a!important;" required>
                </div>
