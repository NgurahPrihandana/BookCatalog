...
<head>
    ...
    <link rel="apple-touch-icon" href="<?=BASEURL; ?>/assets/img/ico/apple-icon-120.png">
    <link rel="shortcut icon" type="image/x-icon" href="<?=BASEURL; ?>/assets/img/ico/favicon.ico">
    <link href="https://fonts.googleapis.com/css?family=Montserrat:300,400,500,600" rel="stylesheet">

    <!-- BEGIN: Vendor CSS-->
    <link rel="stylesheet" type="text/css" href="<?=BASEURL; ?>/assets/vendors/css/vendors.min.css">
    <link rel="stylesheet" type="text/css" href="<?=BASEURL; ?>/assets/vendors/css/ui/prism.min.css">
    <!-- END: Vendor CSS-->
    ...
    <link rel="stylesheet" type="text/css" href="<?= BASEURL; ?>/assets/css/bootstrap-extended.css">
    <link rel="stylesheet" type="text/css" href="<?= BASEURL; ?>/assets/css/colors.css">
    <link rel="stylesheet" type="text/css" href="<?= BASEURL; ?>/assets/css/components.css">
    <link rel="stylesheet" type="text/css" href="<?= BASEURL; ?>/assets/css/components.min.css">
    <link rel="stylesheet" type="text/css" href="<?= BASEURL; ?>/assets/css/themes/dark-layout.css">
    <link rel="stylesheet" type="text/css" href="<?= BASEURL; ?>/assets/css/themes/semi-dark-layout.css">
    
    <!-- BEGIN: Page CSS-->
    <link rel="stylesheet" type="text/css" href="<?= BASEURL; ?>/assets/css/core/menu/menu-types/vertical-menu.css">
    <!-- END: Page CSS-->
                ...
                <div class="navbar-collapse" id="navbar-mobile">
                    ...
                    <ul class="nav navbar-nav float-right">
                        ...
                        <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                                <div class="user-nav d-sm-flex d-none"><span class="user-name text-bold-600">John Doe</span><span class="user-status">Available</span></div><span><img class="round" src="<?= BASEURL; ?>/assets/img/portrait/small/avatar-s-11.jpg" alt="avatar" height="40" width="40"></span>
                            </a>
